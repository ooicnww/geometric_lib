...
class TestCircle:
    def test_valid_circle_area(self):
        ...
        assert result == pytest.approx(expected), f"Expected area to be {expected} but got {result}"
    ...
    def test_valid_circle_perimeter(self):
        ...
        assert result == pytest.approx(expected), f"Expected perimeter to be {expected} but got {result}"
